...
<form class="p-3 mb-2" method="post" novalidate>
    <div class="col-md-4 mb-3">
        <div class="form-group row">
            ...
            <input type="email" name="mailInscrit" class="form-control"  <?php echo (isset($_POST['valider']) && !$manager->getUser($mailInscrit) && !empty($mailInscrit)) ? 'is-invalid' : 'is-valid'; ?> id="Email1"  aria-describedby="emailHelp" placeholder="Enter email" >
    ...
    <div class="col-md-4 mb-3">
        <div class="form-group row">
            ...
            <input type="password" name="Password1" class="form-control" id="Password1"  minlength="5" maxlength="30">
        </div>
    </div>
