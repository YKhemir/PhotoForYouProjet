...
<form  class="p-3 mb-2" method="post"  novalidate>
    <div class="col-md-4 mb-3" >
        ...
        <div class="form-group row" >
            ...
            <input type="text" class="form-control" name="prenom" id="prenom" oninput="saisieTextePrenom(this)" placeholder="Votre prenom">
    ...
    <div class="col-md-4 mb-3" >   
        <div class="form-group row ">
            ...
            <input type="email" class="form-control" name="Email1" oninput="saisiEmail(this)" aria-describedby="emailHelp" placeholder="Enter email" id="mail">
    ...
    <script>
        ...
        // affichage en fonction du bouton photo ou client
